...
const experiences = [
    {
        ...
        company: 'Vonazon',
        position: 'marketing implementation specialist i',
        date: '2020 - Present',
        data: [
            'Build websites for clients hosted on the HubSpot platform.',
            'Receive design and styling guidelines from the Graphic Design team and translate them to performant web pages.',
            'Create and update custom templates using HTML, CSS, Sass, node-sass, Bootstrap, Preact, and the Hubl templating language.',
        ],
    },
    {
